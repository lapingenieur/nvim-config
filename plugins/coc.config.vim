" === This file is the default config from which I deleted some lines to unbloat it

" updatetime : if this milliseconds nothing is typed the swap file will be written to disk
...
" ==== NOTE: UNACTIVE because written in mappings/mappings.vim
...
"      \ coc#refresh()
" already defined in my mappings
...
if has('nvim-0.4.0') || has('patch-8.2.0750')
  " I need <C-f> and <M-f> to be remapped in another file (mappings/normal.vim)
...
" MY_NOTE: n_CTRL-s is already used to save
